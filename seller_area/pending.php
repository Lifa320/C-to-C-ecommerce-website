...
<div class="d-flex bg-light p-2 justify-content-start flex-wrap">
  <!-- Dashboard -->
  <a class="btn btn-outline-none me-2 mb-2" href="pending.php?Dashboard">
  ...
  <div class="btn-group me-2 mb-2">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class="dropdown-item" href="pending.php?view_categories">View Categories</a></li>
...
<div class ="container my-3">
  ...
  <div class ="container my-3">
    <?php
   if(isset($_GET['business_requests'])){
    include('business_requests.php');
}
